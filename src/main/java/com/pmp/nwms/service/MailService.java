...
//    private final ServerConfigService serverConfigService;
    ...
    public MailService(JHipsterProperties jHipsterProperties, JavaMailSender javaMailSender,
                       MessageSource messageSource, SpringTemplateEngine templateEngine, NwmsConfig nwmsConfig) {
...
//        context.setVariable(BASE_URL, jHipsterProperties.getMail().getBaseUrl());
        context.setVariable(BASE_URL, "http://" + rubruWsUrl);
    ...
    @Async
    public void sendActivationCodeToemail(User user) throws MessagingException {
        log.debug("Sending activation email to '{}'", user.getEmail());
        sendEmailFromTemplate(user, "mail/sendCodeEmial", "email.code.title");
    }
