...
public class MultipartFileSender {
    ...
    private static final int DEFAULT_BUFFER_SIZE = 64 * 1024; // ..bytes = 64KB.
    private static final long DEFAULT_EXPIRE_TIME = 604800000L; // ..ms = 1 week.
    private static final String MULTIPART_BOUNDARY = "MULTIPART_BYTERANGES";

    private FileUploadVM vm;
    ...
    public static MultipartFileSender fromVM(FileUploadVM vm) {
        return new MultipartFileSender().setFileUploadVM(vm);
    }

    //** internal setter **//
    private MultipartFileSender setFileUploadVM(FileUploadVM vm) {
        this.vm = vm;
        return this;
    }
    ...
    public void serveResource() throws Exception {
        ...
        long length = vm.getContent().length;
        String fileName = vm.getName();
        ...
        // Prepare streams.
        try (InputStream input = new ByteArrayInputStream(vm.getContent());
